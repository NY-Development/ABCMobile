...
                <p className="text-base">
                    This page is for verifying your subscription payment. If you have not paid, please return to the ABC Home Page. If you just paid and were not redirected, please contact <Link to="/support" className="text-blue-500 underline font-bold cp">support</Link>.
                </p>
            )}
        </div>
