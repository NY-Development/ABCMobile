  ...
  return (
    <SafeAreaView className="flex-1 bg-background-light dark:bg-background-dark" edges={['top']}>
      <View className="flex-row items-center justify-between px-5 py-4">
        <Text className="text-2xl font-bold text-text-main dark:text-gray-100">Explore</Text>
        <Pressable
          onPress={toggle}
      ...
      <View className="flex-1 items-center justify-center px-6">
        <MaterialCommunityIcons name="magnify" size={56} color="#f97316" />
        <Text className="mt-3 text-center text-base text-text-muted dark:text-gray-400">
          Explore section is ready for bakery and product discovery.
        </Text>
      </View>
    </SafeAreaView>
  );
