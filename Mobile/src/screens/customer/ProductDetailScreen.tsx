  ...
  return (
    <SafeAreaView className="flex-1 bg-background-light dark:bg-background-dark" edges={['top', 'bottom']}>
      ...
      >
        ...
        <View className="-mt-8 rounded-t-3xl bg-background-light px-6 pt-8 dark:bg-background-dark">
      ...
      <View className="absolute left-0 right-0 bg-white/80 px-6 pt-4 backdrop-blur-xl dark:bg-background-dark/80" style={{ bottom: Math.max(insets.bottom, 0), paddingBottom: Math.max(insets.bottom + 8, 14) }}>
